...
| "Your detector can't tell whether a transition exists." | Was true, and is fixed: detection AUC 0.23 → **0.81** by specifying the detection statistic (scale-normalised peak). At 0.81 the detector ranks 4th of 19 method-feature combinations — competitive, not superior; stated that way. |
